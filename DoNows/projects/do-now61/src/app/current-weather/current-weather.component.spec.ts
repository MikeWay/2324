...
describe('CurrentWeatherComponent', () => {
  ...
  // TODO 6 - Do this at the end! Remove the comments around the next 3 lines of code to enable the functionality
  // for the getForecast()
  ...
  // TODO 5 - Examine the test below and then change xit to it in the line below to enable the next test
