...
/** ! IMPORTANT! These tests will run very slowly or fail due to the clock updates
 * causing Protractor to fail to detect that Angular is stable
...
describe('workspace-project App', () => {
  ...
  it('should show 20 rows in the table', async () => {
    await page.navigateToTab('buy');
    expect(await page.getNumTableRows()).toEqual(20);
  });
