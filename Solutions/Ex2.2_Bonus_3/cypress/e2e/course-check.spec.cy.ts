describe('Course Check - Ex3.1 Start', () => {
  ...
  it('should NOT YET have a 20 flights displayed - it should be 3', () => {
    cy.visit('/');
    cy.get('app-root app-buy-flight a').click();
    cy.get('app-buy-flight table tbody tr').should('have.length', 3);
  }); 
