describe('Course Check - Ex5.2 Start', () => {
  ...
  it('should have a app-payment element when a flight is selected', () => {
    ...
    // End positive tests for Ex5.2
  // Following tests are to verify that code has not been completed!

  it('should not yet have a app-flight-filter element', () => {
    cy.visit('/');
    cy.get('app-buy-flight app-flight-filter').should('not.exist');
  });
/*
