describe('Course Check - Ex7.1 Start', () => {
  ...
  // End positive tests for Ex7.1
  // Following tests are to verify that code has not been completed!   
  it('should not yet have a form element in app-payment', () => {
    cy.visit('/buy');
    cy.get('app-payment form').should('not.exist');
  });  
/*
