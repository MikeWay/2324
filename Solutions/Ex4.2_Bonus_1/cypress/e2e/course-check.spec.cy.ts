describe('Course Check - Ex5.1 Start', () => {
  ...
  it('should not YET have a button in the table', () => {
    cy.visit('/');
    cy.get('app-buy-flight table tr button').should('not.exist');
  }); 
