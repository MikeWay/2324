describe('Course Check - Ex9.1 Start', () => {
  ...
  // End positive tests for Ex9.1
  // Following tests are to verify that code has not been completed!   

  it('should not yet have an appTime element on the home page', () => {
    cy.visit('/');
    cy.get('span[appTime]').should('not.exist');
  });  
