...
export class BuyFlightComponent implements OnInit {
  ...
  constructor(private flightsService: FlightsService, private activatedRoute: ActivatedRoute, private modalService: NgbModal) { }
  ...
  onFlightClick(content, flight: Flight) {
