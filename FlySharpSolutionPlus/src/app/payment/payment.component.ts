...
export class PaymentComponent implements OnInit {
  ...
  /*
  New event emitter to notify the parent component that the flight has been purchased
  */
  ...
  onSubmit(): void {
    ...
    // Once the form content has been displayed emit the purchased event
    this.closeEvent.emit('Purchased');

  }

  onCancel(): void {
    this.closeEvent.emit('Cancelled');
  }
