...
var mock_flights_1 = require('../model/mock-flights');
var FlightsService = (function () {
    function FlightsService() {
    }
    FlightsService.prototype.getFlights = function () {
        return mock_flights_1.FLIGHTS;
    };
    FlightsService.prototype.getMyFlights = function () {
        return mock_flights_1.MYFLIGHTS;
    };
